...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "businessLayer.webserviceClients.currencyConvertor.ConversionRate")
    @WebMethod(operationName = "ConversionRate", action = "http://www.webserviceX.NET/ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "businessLayer.webserviceClients.currencyConvertor.ConversionRateResponse")
    public double conversionRate(
        @WebParam(name = "FromCurrency", targetNamespace = "http://www.webserviceX.NET/")
        businessLayer.webserviceClients.currencyConvertor.Currency fromCurrency,
        @WebParam(name = "ToCurrency", targetNamespace = "http://www.webserviceX.NET/")
        businessLayer.webserviceClients.currencyConvertor.Currency toCurrency
    );
}
