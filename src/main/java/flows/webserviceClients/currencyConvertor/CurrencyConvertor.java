    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(flows.webserviceClients.currencyConvertor.CurrencyConvertor.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = flows.webserviceClients.currencyConvertor.CurrencyConvertor.class.getResource(".");
