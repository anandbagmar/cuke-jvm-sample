...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "flows.webserviceClients.currencyConvertor.net.webservices.ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "flows.webserviceClients.currencyConvertor.net.webservices.ConversionRateResponse")
