...
public interface CurrencyConvertorSoap {
    ...
    public double conversionRate(
        ...
        flows.webserviceClients.currencyConvertor.net.webservicex.Currency fromCurrency,
        @WebParam(name = "ToCurrency", targetNamespace = "http://www.webserviceX.NET/")
        flows.webserviceClients.currencyConvertor.net.webservicex.Currency toCurrency
    );
}
