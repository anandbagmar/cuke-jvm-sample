 ...
 * generated in the flows.webserviceClients.globalWeather.net.webservices package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: flows.webserviceClients.globalWeather.net.webservices
     * 
     */
